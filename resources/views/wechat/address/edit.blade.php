...
<div class="headerbox">
    <div class="header">
        <div class="headerL">
            <a onclick="location.href='/address'" class="goback"><img src="/vendor/wechat/images/goback.png"/></a>
        </div>
        <div class="headerC">
            <p>编辑收货地址</p>
        </div>
...
<div class="addressDiv">
    <div class="addiv1">
        ...
        <div class="addiv1_r"><input name="name" placeholder="真实姓名" type="text" value="{{$address->name}}"/></div>
    </div>
    <div class="addiv1">
        <div class="addiv1_l">手机号：</div>
        <div class="addiv1_r"><input placeholder="手机号" name="tel" type="text" value="{{$address->tel}}"/></div>
    </div>
    <div class="addiv1">
    ...
    <div class="addiv1">
        ...
        <div class="addiv1_r"><input name="detail" placeholder="街道门牌号" type="text" value="{{$address->detail}}"/></div>
    </div>
</div>
