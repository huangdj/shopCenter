...
@section('content')
    <div class="admin-content-body">
        ...
        <div class="page-body">
            ...
            <form class="am-form am-form-horizontal" action="{{ route('admin.coupons.store') }}" method="post">
                @csrf
                <div class="am-tabs am-margin">
                    <div class="am-form-group">
                        <label for="sort" class="am-u-sm-12 am-u-md-3 am-form-label">名称</label>
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <input type="text" name="name" placeholder="输入优惠券名称">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <input type="text" name="value" placeholder="输入优惠券面值">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <input type="text" name="total" placeholder="输入总数量">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <input type="text" name="min_amount" placeholder="输入金额">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <textarea name="description" cols="30" rows="10" placeholder="输入使用说明"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <label class="am-radio-inline">
                                <input type="radio" value="1" name="enabled" checked> 是
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" value="0" name="enabled"> 否
                            </label>
                        </div>
                    </div>
                </div>
