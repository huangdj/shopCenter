                        ...
                        <div class="box-hd">
                            ...
                            <div class="more clearfix">
                                <h2 class="subtitle">订单号：
                                    <span class="tag tag-subsidy">{{$order->out_trade_no}}</span>
                                </h2>
                            </div>
                        </div>
                        <div class="box-bd">
                                                ...
                                                @if(in_array($order->status, [3, 4]))
                                                    <form style="display: inline-block"
                                                        ...
                                                        <div class="am-form-group">
                                                            <select
                                                                data-am-selected="{btnWidth: '100%',  btnStyle: 'secondary',  maxHeight: 360, searchBox: 1}"
                                                                id="express_id">
                                        ...
                                        @if($order->status >= 4)
                                            ...
                                            <div class="order-delivery order-delivery-detail">
                                                ...
                                                <div class="delivery-list-wrapper">
                                                    <iframe
                                                        src="http://m.kuaidi100.com/index_all.html?type={{ $order->express->code}}&postid={{ $order->express_code}}"
                                            ...
                                            <tr>
                                                <td class="col col-thumb">
                                                    <div class="figure figure-thumb">
                                                        <a target="_blank"
                                                           href="{{route('admin.products.edit', $order_product->product->id)}}">
                                ...
                                <div class="order-detail-total">
                                    <table class="total-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="num">{{doubleval($order->total_price + $order->express_money)}}</span>元
                                            </td>
                                        </tr>
                                        <tr>
