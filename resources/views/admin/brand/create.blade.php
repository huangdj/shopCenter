...
@section('content')
    <div class="admin-content-body">
        ...
        <div class="page-body">
            ...
            <form class="am-form am-form-horizontal" action="{{ route('admin.brands.store') }}" method="post">
                @csrf
                ...
                <div class="am-form-group">
                    <div class="am-u-sm-12 am-u-md-9 am-u-md-offset-3">
                        <button type="button" onclick="location.href='/admin/brands'" class="am-btn am-btn-default am-btn-sm am-radius">返 回</button>
