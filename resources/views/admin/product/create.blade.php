                ...
                <div class="am-tabs am-margin" data-am-tabs>
                    ...
                    <div class="am-tabs-bd">
                        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" value="1" name="is_seckill"> 是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="0" name="is_seckill" checked> 否
                                    </label>
                                </div>
                            </div>

                            <div class="am-form-group discount_temp">
                            ...
                            <div class="am-margin-top discount_temp">
                            ...
                            <div class="am-form-group seckill_time">
