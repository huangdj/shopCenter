<div class="am-tab-panel am-fade  @if($index==0) am-in am-active  @endif" id="tab{{$index}}">
    <table class="am-table am-table-hover">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="buttons[{{$index}}][name]" value="{{$button['name'] ?? ''}}"
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="buttons[{{$index}}][sub_button][{{$i}}][name]"
                           value="{{$button['sub_button']["$i"]["name"] ?? ''}}"
                           class="am-form-field am-radius">
                </td>
                <td>
