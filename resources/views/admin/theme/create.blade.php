...
@section('content')
    <div class="admin-content-body">
        ...
        <div class="page-body">
            ...
            <form class="am-form am-form-horizontal" action="{{ route('admin.themes.store') }}" method="post">
                @csrf
                <div class="am-tabs am-margin">
                    <div class="am-form-group">
                        <label for="sort" class="am-u-sm-12 am-u-md-3 am-form-label">主题名称</label>
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <input type="text" name="name" placeholder="输入主题名称">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <label class="am-radio-inline">
                                <input type="radio" value="1" name="is_left"> 是
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" value="0" name="is_left" checked> 否
                            </label>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <label class="am-radio-inline">
                                <input type="radio" value="1" name="is_right"> 是
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" value="0" name="is_right" checked> 否
                            </label>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-12 am-u-md-5 am-u-end">
                            <label class="am-radio-inline">
                                <input type="radio" value="1" name="is_bottom"> 是
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" value="0" name="is_bottom" checked> 否
                            </label>
                ...
                <div class="am-form-group">
                    <div class="am-u-sm-12 am-u-md-9 am-u-md-offset-3">
                        <button type="button" onclick="location.href='/admin/themes'" class="am-btn am-btn-default am-btn-sm am-radius">返 回</button>
